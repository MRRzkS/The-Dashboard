...
export const DashboardShell = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div 
      ...
      // THE DEFINITIVE FIX: Restored min-h-screen to force full viewport height
      className="relative min-h-screen w-full bg-[var(--mafia-base)] transition-colors duration-700 pb-10"
    >
      
      {/* 1. Atmosphere - Fixed background */}
      <motion.div
        animate={{
      ...
      {/* 2. The Spotlight */}
      <div
        className="pointer-events-none absolute -inset-px z-10 transition-opacity duration-300 fixed"
        style={{
          opacity,
      ...
      {/* 3. Grain */}
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none z-[1] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] fixed" />
